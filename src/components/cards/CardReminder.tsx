...
export default function CardReminder({ data, updateData, unlocked }: Props) {
  ...
  const handleConfirm = () => {
    ...
    toast({ title: "تم!", description: "سيتم تذكيرك يومياً عبر البريد الإلكتروني" });
  };
      ...
      <CardContent className="space-y-4">
        <div className="flex items-start gap-3 p-3 bg-accent rounded-lg">
          ...
          <p className="text-sm text-accent-foreground">
            سنذكّرك يومياً على الساعة <strong>20:00</strong> عبر البريد الإلكتروني لاستخدام البومادة.
          </p>
        </div>
